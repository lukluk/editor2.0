...
$pdf->SetAuthor('PDF Tool');
$pdf->SetTitle('Letterhead PDF');
$pdf->SetSubject('www.pdftool.eu');
$pdf->SetKeywords('pdf, tool, drag and drop');
...
$pdf->Output("stock/users/".md5($_GET['email']).'/'.str_replace(' ', '', $_GET['name']).'.pdf', 'F');
